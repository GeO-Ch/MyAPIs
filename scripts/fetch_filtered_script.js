import {depopulateTable} from './depopulateTable.js';
import {clickHandler} from './clickHandler.js';

document.addEventListener("click", function (event) {
  var urlValue = clickHandler(event);
...
function filtered(urlValue) {
  fetch(`https://hplussport.com/api/products/${urlValue}`)
